...
export const WhatsAppButton: React.FC = () => {
  ...
  // Strip non-digit characters to get clean WhatsApp phone number
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.9 }}
      className="fixed bottom-6 left-6 z-50 flex items-center justify-center bg-[#25D366] hover:bg-[#20ba59] text-white w-14 h-14 rounded-full shadow-2xl shadow-emerald-900/40 border border-white/30 transition-all cursor-pointer group"
      aria-label="Chat on WhatsApp"
      title={`Chat on WhatsApp (${content.contactHelpline})`}
    >
      ...
      <svg
        className="w-7 h-7 fill-current text-white shrink-0"
        viewBox="0 0 24 24"
      >
